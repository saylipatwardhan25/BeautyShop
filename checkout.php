...
var orderTotal = "<?php echo $grand_total; ?>";
...
paypal.Buttons({
    createOrder: function(data, actions) {
        return actions.order.create({
            purchase_units: [{
                amount: {
                    value: orderTotal // Dynamic amount from PHP
                }
            }]
        });
    },
    onApprove: function(data, actions) {
        return actions.order.capture().then(function(details) {
            ...
            // Send payment details + form data to backend
            fetch('payment_success.php', {
                ...
                body: JSON.stringify({
                    ...
                    method: 'PayPal',
                    address: {
                        flat: document.querySelector('[name="flat"]').value,
                        street: document.querySelector('[name="street"]').value,
                        city: document.querySelector('[name="city"]').value,
                        state: document.querySelector('[name="state"]').value,
                        country: document.querySelector('[name="country"]').value,
                        pin: document.querySelector('[name="pin_code"]').value
                    },
                    total: orderTotal
                })
            }).then(res => res.json())
